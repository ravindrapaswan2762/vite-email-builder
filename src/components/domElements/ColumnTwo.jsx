...
const ColumnTwo = ({ handleDelete, id }) => {
  ...
  useEffect( ()=>{
    console.log(`activeWidgetId: ${activeWidgetId}, activeParentId: ${activeParentId}, activeColumn: ${activeColumn} in ColumnTwo`)
  }, [activeWidgetId, activeParentId, activeColumn]);
  ...
  const handleDragLeave = (e, ref) => {
    ...
    console.log("handleDragLeave called in columnTwo: ",dragState);
  };
  ...
  const handleDragEnter = (e, column, ref) => {
    ...
    if (dragState.column !== column) {
      ...
      console.log("handleDragEnter called columnTwo: ",dragState);
  
      // Reset drop indicators in other columns
      setDropIndex(null);
      setDropPosition(null);
  ...
  return (
    ...
    ref={twoColumnRef}
    className={`relative grid gap-1 group transition-all duration-300 pt-1 pb-1
  ...
  onClick={(e) => {
    ...
    console.log("activeParentId in columnTwo: ",activeParentId);
    console.log("activeColumn in columnTwo: ",activeColumn);
  }}
...
>
  ...
  <div
    ...
    className={`rounded-md text-center min-h-[150px] hover:border hover:border-pink-400 pt-1 pb-1
                ...
                ${(dragState.isDragging && dragState.column === "childrenA") ? "bg-blue-100 border border-pink-400" : "bg-transparent"}
  ...
  <div
    ...
    className={`rounded-md text-center min-h-[150px] hover:border hover:border-pink-400 pt-1 pb-1
                ${activeBorders ? 'border border-pink-200' : ''}
                ${(dragState.isDragging && dragState.column === "childrenB") ? "bg-blue-100 border-pink-400" : "bg-transparent"}
                ${(activeWidgetId == id) ? "border border-pink-400" : ""}
              `}
  >
