...
//   const handleDragEnterParent = (e) => {
//     e.stopPropagation();
  
//     // Ensure the event is triggered only for the parent div
//     if (e.currentTarget === parentRef.current) { // Check if drag entered the parent
//       console.log("Drag entered top-level parent.");
//       if (!isDragging) {
//         setPaddingTop(true);
//         setIsDragging(true);
//         dispatch(setActiveBorders(true)); // Visual feedback
//         dispatch(setColumnOneExtraPadding(true));
//       }
//     }
//   };
...
//     if (parentRef.current && !oneColumnRef.current.contains(e.relatedTarget)) {
//       setIsDragging(false);
//       setPaddingTop(false);
...
//     const handleDragEnterChild = (e) => {
//       e.stopPropagation();
    
//       // Prevent triggering when dragging over the child container
//       if (e.currentTarget === childContainerRef.current) {
//         console.log("Drag entered child container.");
//         setPaddingTop(false); // Close paddingTop when dragging into child container
//       }
//     };
...
//       ref={parentRef} // Updated parent reference

//       onDragOver={handleDragOver}
//       onMouseEnter={() => setHoveredColumn(true)}
//       onMouseLeave={() => setHoveredColumn(false)}

//       onDragEnter={handleDragEnterParent} 
//       onDragLeave={handleDragLeave}
...
//                       ref={childContainerRef} // Updated child container reference
//                       >
